...
import { AfterViewInit, ApplicationRef, ComponentFactoryResolver, ElementRef, EventEmitter, Injector, OnDestroy, OnInit, QueryList, TemplateRef, ViewContainerRef } from '@angular/core';
...
export declare class OTableComponent extends OServiceComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    originalFilterColumnActiveByDefault: boolean;
    ...
    onClick: EventEmitter<OnClickTableEvent>;
    onDoubleClick: EventEmitter<OnClickTableEvent>;
    ...
    expandableItem: SelectionModel<Element>;
    ...
    constructor(injector: Injector, elRef: ElementRef, dialog: MatDialog, _viewContainerRef: ViewContainerRef, appRef: ApplicationRef, _componentFactoryResolver: ComponentFactoryResolver, form: OFormComponent);
    ngOnInit(): void;
    ...
    reloadData(): void;
    handleClick(item: any, rowIndex: number, $event: MouseEvent): void;
    doHandleClick(item: any, rowIndex: number, $event: MouseEvent): void;
    ...
    clearColumnFilters(triggerDatasourceUpdate?: boolean): void;
